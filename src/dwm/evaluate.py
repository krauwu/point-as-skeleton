...
# import torch.hub as _hub, traceback

# _old = _hub.download_url_to_file

# def _wrapped(url, dst, hash_prefix=None, progress=True):
#     print("\n=== download_url_to_file called ===")
#     print("URL:", url)
#     print("DST:", dst)
#     print("=== end stack ===\n")
#     return _old(url, dst, hash_prefix, progress)
...
if __name__ == "__main__":
    ...
    # _hub.download_url_to_file = _wrapped
